...
export default function Terms() {
  return (
    <>
      ...
      <section id="agreement">
        ...
        <p>We are Roam ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," "<strong>our</strong>"), a company registered in Washington, United States at __________, Tacoma, WA.</p>
        <p>We operate the website <a href="https://roam-dusky-alpha.vercel.app">https://roam-dusky-alpha.vercel.app</a> (the "<strong>Site</strong>"), the mobile application Roam (the "<strong>App</strong>"), as well as any other related products and services that refer or link to these legal terms (the "<strong>Legal Terms</strong>") (collectively, the "<strong>Services</strong>").</p>
        <p>You can contact us by phone at 206-476-7818, email at <a href="mailto:nomadcode33@gmail.com">nomadcode33@gmail.com</a>, or by mail to __________, Tacoma, WA, United States.</p>
        <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("<strong>you</strong>"), and Roam, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
        <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <a href="mailto:nomadcode33@gmail.com">nomadcode33@gmail.com</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
  ...
  <section id="ip">
    ...
    <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:nomadcode33@gmail.com">nomadcode33@gmail.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
    ...
    <p>We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the "<a href="#copyrightyes">Copyright Infringements</a>" section below.</p>
  </section>
  ...
  <section id="dispute-resolution">
    ...
    <p>
      To resolve any dispute, controversy, or claim arising out of or related to these Legal Terms
      (each a "Dispute," collectively "Disputes") quickly and cost-effectively, you and Roam agree
      to first attempt good-faith informal negotiations for at least thirty (30) days before either
      party initiates arbitration. This negotiation period begins once one party sends written
      notice to the other.
    </p>

    <h3>Binding Arbitration</h3>
    <p>
      If a Dispute cannot be resolved through informal negotiations, it will be resolved through
      binding arbitration rather than in court, except for the specific exceptions listed below.
      By agreeing to this provision, you are giving up your right to sue in court and to a jury
      trial. Arbitration will be administered under the American Arbitration Association's ("AAA")
      Commercial Arbitration Rules and, where relevant, its Supplementary Procedures for Consumer
      Related Disputes.
    </p>
    <p>
      Arbitration fees and the arbitrator's compensation will be allocated according to the AAA
      Consumer Rules. Arbitration may take place in person, by document submission, by phone, or
      online. The arbitrator will issue a written decision, though a full statement of reasoning is
      only required if either party asks for one. The arbitrator must apply applicable law, and any
      award can be challenged if they fail to do so. Unless AAA rules or applicable law require
      otherwise, arbitration will take place in Pierce County, Washington. Either party may still go
      to court to compel arbitration, pause proceedings pending arbitration, or to confirm, modify,
      vacate, or enter judgment on an arbitration award.
    </p>
    <p>
      If a Dispute proceeds in court instead of arbitration for any reason, it will be brought in
      the state or federal courts located in Pierce County, Washington, and both parties consent to
      personal jurisdiction and venue there, waiving any objection based on inconvenient forum. The
      United Nations Convention on Contracts for the International Sale of Goods and the Uniform
      Computer Information Transaction Act (UCITA) do not apply to these Legal Terms.
    </p>
    <p>
      Any Dispute must be brought within one (1) year of the date the underlying claim arose. If
      this time limit is found unenforceable for a given Dispute, that Dispute will not be
      arbitrated and will instead be decided by a court with jurisdiction as described above, with
      both parties agreeing to that court's personal jurisdiction.
    </p>

    <h3>Restrictions</h3>
    <p>
      The parties agree that arbitration will be limited to the Dispute between them individually.
      To the fullest extent the law allows: (a) no arbitration may be combined with any other
      proceeding; (b) neither party has the right to arbitrate any Dispute as a class action or use
      class action procedures; and (c) neither party may bring a Dispute in a representative
      capacity on behalf of the general public or any other persons.
    </p>

    <h3>Exceptions to Informal Negotiations and Arbitration</h3>
    <p>
      The parties agree that the following types of Disputes are not subject to the informal
      negotiation and arbitration provisions above: (a) any Dispute seeking to enforce, protect, or
      determine the validity of either party's intellectual property rights; (b) any Dispute
      involving allegations of theft, piracy, invasion of privacy, or unauthorized use; and (c) any
      claim for injunctive relief. If this exception is found unlawful or unenforceable as to a
      particular Dispute, neither party will elect to arbitrate that Dispute, and it will instead be
      decided by a court with jurisdiction as described above, with both parties agreeing to that
  ...
  <section id="corrections">
    ...
    <p>
      The Services may contain typographical errors, inaccuracies, or omissions — including in
      descriptions, pricing, availability, and other details. Roam reserves the right to correct any
      such errors, inaccuracies, or omissions, and to change or update information on the Services
  ...
  <section id="disclaimer">
    <h2>18. Disclaimer</h2>
    <p>
      THE SERVICES ARE PROVIDED ON AN "AS-IS" AND "AS-AVAILABLE" BASIS. YOUR USE OF THE SERVICES IS
      ENTIRELY AT YOUR OWN RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, ROAM DISCLAIMS ALL
      WARRANTIES, WHETHER EXPRESS OR IMPLIED, IN CONNECTION WITH THE SERVICES AND YOUR USE OF THEM,
      INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
      PURPOSE, AND NON-INFRINGEMENT. ROAM MAKES NO REPRESENTATIONS OR WARRANTIES ABOUT THE ACCURACY
      OR COMPLETENESS OF ANY CONTENT ON THE SERVICES, OR THE CONTENT OF ANY LINKED WEBSITES OR
      MOBILE APPLICATIONS, AND WILL NOT BE LIABLE FOR: (1) ERRORS, MISTAKES, OR INACCURACIES IN
      CONTENT OR MATERIALS; (2) PERSONAL INJURY OR PROPERTY DAMAGE OF ANY KIND RESULTING FROM YOUR
      ACCESS TO OR USE OF THE SERVICES; (3) ANY UNAUTHORIZED ACCESS TO OR USE OF ROAM'S SECURE
      SERVERS AND/OR ANY PERSONAL OR FINANCIAL INFORMATION STORED THERE; (4) ANY INTERRUPTION OR
      STOPPAGE OF TRANSMISSION TO OR FROM THE SERVICES; (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR
      SIMILAR ISSUES TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY; AND/OR (6) ANY
      ERRORS OR OMISSIONS IN CONTENT, OR ANY LOSS OR DAMAGE INCURRED AS A RESULT OF USING CONTENT
      POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE THROUGH THE SERVICES. ROAM DOES NOT WARRANT,
      ENDORSE, GUARANTEE, OR TAKE RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY
      A THIRD PARTY THROUGH THE SERVICES, ANY LINKED WEBSITE, OR ANY WEBSITE OR APP FEATURED IN ANY
      BANNER OR OTHER ADVERTISEMENT, AND ROAM WILL NOT BE A PARTY TO, OR IN ANY WAY RESPONSIBLE FOR
      MONITORING, ANY TRANSACTION BETWEEN YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS
      WITH ANY PURCHASE THROUGH ANY MEDIUM OR ENVIRONMENT, USE YOUR OWN JUDGMENT AND EXERCISE
      APPROPRIATE CAUTION.
    </p>
  </section>
  ...
  <section id="limitations-of-liability">
    ...
    <p>
      IN NO EVENT WILL ROAM OR ITS DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD
      PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE
      DAMAGES, INCLUDING LOST PROFITS, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM
      YOUR USE OF THE SERVICES, EVEN IF ROAM HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
      NOTWITHSTANDING ANYTHING TO THE CONTRARY HEREIN, ROAM'S LIABILITY TO YOU FOR ANY CAUSE
      WHATSOEVER, REGARDLESS OF THE FORM OF ACTION, WILL AT ALL TIMES BE LIMITED TO ONE HUNDRED
      DOLLARS ($100.00) USD. CERTAIN STATE AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON
      IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO
      YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY, AND YOU MAY HAVE
      ADDITIONAL RIGHTS.
    </p>
  </section>
  ...
  <section id="indemnification">
    ...
    <p>
      You agree to defend, indemnify, and hold Roam harmless — including its subsidiaries,
      affiliates, and their respective officers, agents, partners, and employees — from any loss,
      damage, liability, claim, or demand, including reasonable attorneys' fees and expenses, made
      by any third party arising out of: (1) your Contributions; (2) your use of the Services; (3)
      your breach of these Legal Terms; (4) any breach of the representations and warranties in
      these Legal Terms; (5) your violation of the rights of a third party, including intellectual
      property rights; or (6) any harmful act you direct toward another user of the Services with
      whom you connected through the Services. Notwithstanding the foregoing, Roam reserves the
      right, at your expense, to assume exclusive defense and control of any matter for which you
      are required to indemnify Roam, and you agree to cooperate, at your expense, with that
      defense. Roam will make reasonable efforts to notify you of any such claim, action, or
      proceeding subject to this indemnification once it becomes aware of it.
    </p>
  </section>
  ...
  <section id="user-data">
    <h2>21. User Data</h2>
    <p>
      Roam will maintain certain data that you transmit to the Services for the purpose of managing
      performance, as well as data related to your use of the Services. Although Roam performs
      routine data backups, you are solely responsible for all data you transmit or that relates to
      any activity you've undertaken using the Services. You agree that Roam has no liability to you
      for any loss or corruption of such data, and you waive any right of action against Roam
  ...
  <section id="electronic-communications">
    ...
    <p>
      Visiting the Services, sending Roam emails, and completing online forms all constitute
      electronic communications. You consent to receive electronic communications, and you agree
      that any agreements, notices, disclosures, and other communications Roam provides to you
      electronically — via email or through the Services — satisfy any legal requirement that such
      communications be in writing. You agree to the use of electronic signatures, contracts, orders,
      and other records, and to electronic delivery of notices, policies, and records of transactions
      initiated or completed by Roam or through the Services. You waive any rights or requirements
      under any statutes, regulations, rules, ordinances, or other laws in any jurisdiction that
      require an original signature, or delivery or retention of non-electronic records, or payments
      or the granting of credit by any means other than electronic means.
    </p>
  </section>
  ...
  <section id="california-users">
    ...
    <p>
      If a complaint with Roam is not satisfactorily resolved, you can contact the Complaint
  ...
  <section id="miscellaneous">
    ...
    <p>
      These Legal Terms, together with any policies or operating rules posted by Roam on or in
      connection with the Services, constitute the entire agreement and understanding between you
      and Roam. Roam's failure to exercise or enforce any right or provision of these Legal Terms
      will not operate as a waiver of that right or provision. These Legal Terms apply to the
      fullest extent permitted by law. Roam may assign any or all of its rights and obligations to
      others at any time. Roam will not be responsible or liable for any loss, damage, delay, or
      failure to act caused by any circumstance beyond its reasonable control. If any provision or
      part of a provision of these Legal Terms is found to be unlawful, void, or unenforceable, that
      provision or part is deemed severable and does not affect the validity or enforceability of
      any remaining provisions. There is no joint venture, partnership, employment, or agency
      relationship created between you and Roam as a result of these Legal Terms or your use of the
      Services. You agree that these Legal Terms will not be construed against Roam merely because
      Roam drafted them. You waive any and all defenses you may have based on the electronic form of
      these Legal Terms and the lack of physical signing by the parties to execute them.
    </p>
  </section>
  ...
  <section id="contact-us">
    <h2>25. Contact Us</h2>
    <p>
      To resolve a complaint regarding the Services, or to receive further information about use of
      the Services, please contact us at:
    </p>
    <p>
      Roam<br>
      [Insert Street Address]<br>
      Tacoma, WA [Insert ZIP Code]<br>
      United States<br>
      Phone: [Insert Business Phone Number]<br>
